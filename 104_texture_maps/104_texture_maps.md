...
This file consists of a few steps. First, we import the necessary packages.
```
...
Notice how the texture is higher resolution than the mesh resolution in many places!
...
### Suggested approach
1) Independently flatten all triangles to the plane. Hint: Use the approach in exercise 101. See the function [trivial_parameterization()](common/utils.py).
...
Notice how there is a lot of unused space. That is OK; this is by no means an optimal packing, but it will be sufficient for the purposes of this exercise, and more complex packings are beyond the scope of this module.
